        ...
        if (device.deviceType === 'urn:Belkin:device:bridge:1') {
            ...
            client.getEndDevices(function (err, endDevices) {
                ...
                endDevices.forEach(function (endDevice) {
                    ...
                    var on = endDevice.currentState[0] === '1';
                    var level = parseInt(endDevice.currentState[1].split(':')[0]);
            ...
            client.on('statusChange', function (id, capability, value) {
                ...
                if (capability === '10006') {
                    ...
                    devices[id].state.level = parseInt(value.split(':')[0]);
                    devices[id].state.hsl = [0, 0, devices[id].state.level / 510];
                }
