...
ffmpeg.getEncoder = function (options, rotation) {
    ...
    if (options.inputrate) {
        args.push('-r', options.inputrate);
    }
    ...
    case 'vp8-motion':
        // Encode recorded motion
        args.push('-vf', vf);
        args.push('-f', 'webm', '-c:v', 'libvpx', '-b:v', '1M', '-crf', 10, '-static-thresh', 100, '-r', options.framerate, '-');
        break;
