...
ffmpeg.getEncoder = function (options, rotation) {
    ...
    case 'mpeg1':
        ...
        args.push('-f', 'mpeg1video', '-b:v', 100000, '-bf', 0, '-g', 48, '-r', 24, '-');
        break;

    case 'vp8':
        // Intended for Android 4.0+
        args.push('-f', 'webm', '-c:v', 'libvpx', '-b:v', 100000, '-keyint_min', 50, '-r', 25, '-quality', 'realtime', '-');
        break;

    case 'vp9':
        // Intended for Android 4.4+
        args.push('-f', 'webm', '-c:v', 'libvpx-vp9', '-b:v', 100000, '-keyint_min', 50, '-r', 25, '-quality', 'realtime', '-');
        break;
