...
ffmpeg.getEncoder = function (options, rotation) {
    ...
    case 'mpeg1':
        ...
        args.push('-vf', vf);
        args.push('-qscale:v', 7);
        args.push('-f', 'mpeg1video', '-b:v', '800k', '-bf', 0, '-g', 50, '-r', 25, '-');
        break;
    ...
    case 'vp8':
        ...
        args.push('-vf', vf);
        args.push('-f', 'webm', '-c:v', 'libvpx', '-b:v', '800k', '-keyint_min', options.framerate * 2, '-r', options.framerate, '-quality', 'realtime', '-cpu-used', '-5', '-crf', 33, '-');
        break;
    ...
    case 'vp9':
        ...
        vf += ",setpts='(RTCTIME - RTCSTART) / (TB * 1000000)'";
        args.push('-vf', vf);
        args.push('-f', 'webm', '-c:v', 'libvpx-vp9', '-b:v', '800k', '-keyint_min', options.framerate * 2, '-r', options.framerate, '-quality', 'realtime', '-cpu-used', '-5', '-crf', 33, '-');
        break;
