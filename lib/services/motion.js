...
var motionDetectors = {}, motionRecorders = {}, motionAlerters = {};
...
function getMotionDetector(cameraid)
{
    if (motionDetectors[cameraid]) {
        return motionDetectors[cameraid];
    }
    ...
    var motion = motionDetectors[cameraid] = new MotionStream({ resolution: [camera.width, camera.height] });
...
function enableMotionRecording(cameraid, cb)
{
    ...
    var motion = getMotionDetector(cameraid);
